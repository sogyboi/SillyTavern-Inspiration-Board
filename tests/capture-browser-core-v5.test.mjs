...
test('Capture Browser version and release point to v0.5.3', () => {
  assert.equal(CAPTURE_BROWSER_VERSION, '0.5.3');
  assert.match(CAPTURE_BROWSER_RELEASE, /capture-browser-v0\.5\.3$/);
});
