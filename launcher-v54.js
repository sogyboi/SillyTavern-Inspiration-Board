import './launcher-v41.js?v=0.5.4';
import { installCaptureBrowserBridge } from './capture-browser-v5.js?v=0.5.4';
...
function enhance() {
  ...
  if (note) note.textContent = 'Capture-first character workspace with Android Capture Browser v0.5.4: direct native saves now negotiate SillyTavern CSRF/session data automatically, with Android Share kept as the fallback.';
