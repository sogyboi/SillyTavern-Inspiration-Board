...
text = path.read_text()
needle = "activity = replace_once(activity, helper_anchor, helper_insert, 'UI-thread helper insertion')\n"
if needle not in text:
    raise SystemExit('helper insertion call not found in tools/apply_v053.py')
insert = (
