import './launcher-v41.js?v=0.5.6';
import { installCaptureBrowserBridge } from './capture-browser-v5.js?v=0.5.6';
...
function enhance() {
  ...
  if (note) note.textContent = 'Capture-first character workspace. v0.5.6 uses a private raw native transport that bypasses SillyTavern body parsers, and the companion Test button now verifies the real POST save path.';
